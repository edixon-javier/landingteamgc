    ...
    <AnimatePresence>
      {isActive && (
        <motion.div
          ...
          className="w-full bg-gray-100 dark:bg-gray-800 rounded-lg overflow-hidden mt-4 mb-8"
        >
          <div className="flex justify-between items-center bg-gray-200 dark:bg-gray-700 p-2 px-4">
