...
export const HeroSection = () => {
  return (
    <section className="min-h-screen relative flex flex-col text-center text-white overflow-hidden">
      {/* Video de fondo */}
      <video
        autoPlay
        loop
      ...
      >
        <source
          src={getVideoPath("/assets/videos/equipogc.mp4")}
          type="video/mp4"
        />
